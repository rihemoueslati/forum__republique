...
import 'package:forum_republique/pages/chat.dart';
import 'package:forum_republique/pages/event.dart';
import 'package:forum_republique/pages/map.dart';
import 'package:forum_republique/pages/reminder.dart';
import 'package:forum_republique/pages/splash_screen.dart';
import 'package:forum_republique/pages/widgets/DataTable/data_table.dart';
import 'package:forum_republique/pages/widgets/DataTableMysqlDemo/DataTableDemo.dart';
import 'package:forum_republique/pages/widgets/header_widget.dart';
import 'package:forum_republique/screens/welcome/welcome_screen.dart';
import 'body.dart';
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                title: Text('Messagerie', style: TextStyle(fontSize: _drawerFontSize, color: Theme.of(context).accentColor),
                ),
                onTap: () {
              ...
              ListTile(
                leading: Icon(Icons.login_rounded,size: _drawerIconSize,color: Theme.of(context).accentColor),
                title: Text('body', style: TextStyle(fontSize: _drawerFontSize, color: Theme.of(context).accentColor),
                ),
                onTap: () {
              ...
              ListTile(
                leading: Icon(Icons.event_available,size: _drawerIconSize,color: Theme.of(context).accentColor),
                title: Text('Evenements', style: TextStyle(fontSize: _drawerFontSize, color: Theme.of(context).accentColor),
                ),
                onTap: () {
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text('Rihem Oueslati', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
                                    ...
                                    ...ListTile.divideTiles(
                                      ...
                                      tiles: [
                                        ...
                                        ListTile(
                                          ...
                                          title: Text("Email"),
                                          subtitle: Text("orihem47@gmail.com"),
                                        ),
                                        ListTile(
                                          leading: Icon(Icons.phone),
                                          title: Text("Phone"),
                                          subtitle: Text("24515846"),
                                        ),
                                        ListTile(
